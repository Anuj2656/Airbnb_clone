                       ...
                       child: Padding(
                         padding:  EdgeInsets.symmetric(horizontal: 1,vertical: 10),
                            child: Row(
                             ...
                             children: <Widget>[
                               Icon(Icons.search),
                               Text("Location",style:TextStyle(fontSize: 13,color: Colors.black54),
                      ...
                      children: <Widget>[
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            ...
                            Center(child: Text("India",style:TextStyle(fontSize: 20,color: Colors.white))),
                          ],
                        ),
                        Positioned(
                          top: 0,
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Align(
                              ...
                              child: Text("Airbnb",style: TextStyle(color:Color(0xfff35e0b)),)),
                        ),
                        Padding(
                          padding: const EdgeInsets.only(bottom: 10,right: 10,left: 10),
                          child: Text("Meet people everywhere in india and discover the most beautiful places in the country. With airbnb, find them.",style: TextStyle(fontSize: 13,color:Color(0xffd3d3d3)),),
                        ),
                        Expanded(
                          child: Container(
                            color: Colors.white,
                            child: PageView(
                              ...
                              children: <Widget>[
                                buildScrollActivities("the best vacations", "assets/images/3.jpg"),
                                buildScrollActivities("family accommodation ", "assets/images/4.jpg"),
                                buildScrollActivities("In a beach", "assets/images/1.jpg"),
                                buildScrollActivities("The best apartments", "assets/images/2.jpg"),
                              ],
                            ),
                          ),
                        )
