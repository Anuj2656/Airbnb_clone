             ...
             // mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Align(
                    alignment: Alignment.centerLeft,
                    child: Text("Number of places".toUpperCase(),style: TextStyle(color: Colors.grey,fontSize: 12,),),
                  ),
                ),
                Padding(
                  ...
                  child: Material(
                    ...
                    //  margin: EdgeInsets.symmetric(vertical: 10),
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[
                          Text("Number of people",style: TextStyle(fontSize: 12),overflow: TextOverflow.ellipsis,),
                         Counter(
                            minValue: 0,
                            maxValue: 10,
                            decimalPlaces: 0,
               ...
               Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          RangeSlider(
                           ...
                           labels: RangeLabels(_rangePrixValeurs.start.toString().split(".").first+" Rupee",_rangePrixValeurs.end.toString().split(".").first+" DA"),
                ...
                Padding(
                  ...
                  child: Align(
                    alignment: Alignment.centerLeft,
                    child: Text("Choose the date of your stay".toUpperCase(),style: TextStyle(color: Colors.grey,fontSize: 12,),),
                  ),
                ),
                dp.RangePicker(
