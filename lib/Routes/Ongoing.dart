      ...
      child: Column(
        ...
        children: [
         Image.asset(imagePath,width: MediaQuery.of(context).size.width,),
          ...
          const SizedBox(height: 15,),
          Text(title,style: const TextStyle(fontSize: 22,color: Colors.black54,fontWeight: FontWeight.w600),textAlign: TextAlign.center,),
          const SizedBox(height: 15,),
          Text(text,style: const TextStyle(fontSize: 18,color: Colors.black38),textAlign: TextAlign.center,),
