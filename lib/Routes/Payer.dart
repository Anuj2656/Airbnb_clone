           ...
           children: <Widget>[
            Row(
              ...
              children: <Widget>[
                ...
                Text("Confirm and pay",style: TextStyle(fontSize: 18),),
              ],
            ),
             SizedBox(height: 30),
             Container(
                 ...
                 children: <Widget>[
                   ...
                   Flexible(
                     child: Column(
                       ...
                       crossAxisAlignment: CrossAxisAlignment.start,
                       children: <Widget>[
                         Text("Apartment in a residence",style: TextStyle(fontSize: 12),overflow: TextOverflow.ellipsis,maxLines: 1,),
                         SizedBox(height: 10,),
                         Text("Appartement",style: TextStyle(fontSize: 16),overflow: TextOverflow.ellipsis,maxLines: 1,),
                         SizedBox(height: 8,),
                         Text("Delhi centre",style: TextStyle(fontSize: 16),overflow: TextOverflow.ellipsis,maxLines: 1,),
                         SizedBox(height: 8,),
                         Row(
                           children: <Widget>[
                             Container(
             ...
             Text("Your journey",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
             SizedBox(height: 15,),
             Row(
             ...
             Row(
               mainAxisAlignment: MainAxisAlignment.spaceBetween,
               children: <Widget>[
                 Text("Travelers",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17),),
                 InkWell(
                   onTap: (){
             ...
             SizedBox(height: 10,),
             Text("5 Travelers",style: TextStyle(color: Colors.grey,fontSize: 16),),
             SizedBox(height: 10,),
             Text("Price details",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 17),),
             SizedBox(height: 10,),
             Row(
               mainAxisAlignment: MainAxisAlignment.spaceBetween,
               children: <Widget>[
               ...
               child: MaterialButton(
                 ...
                 child: Container(
                   width: MediaQuery.of(context).size.width,
                     ...
                     child: Text("Confirm and Pay",style: TextStyle(color: Colors.white),textAlign: TextAlign.center,)),
               ),
             )
           ]
          ),
