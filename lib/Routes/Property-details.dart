...
class _PropertyDetailsState extends State<PropertyDetails> {
          ...
          child: Column(
            children: <Widget>[
              ...
              Padding(
                ...
                Align(
                  alignment: Alignment.topLeft,
                  child:  Text("Noida, Delhi, India",style: TextStyle(color: Colors.black54,fontSize: 12,fontWeight: FontWeight.w400,letterSpacing: 0.2),overflow: TextOverflow.ellipsis,),
                ) ,
              ),
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text("Entire place",style: TextStyle(color: Colors.black,fontSize: 22,fontWeight: FontWeight.w600,letterSpacing: 0.2),overflow: TextOverflow.ellipsis,),
                        Text("Name : Anuj",style: TextStyle(color: Colors.black,fontSize: 15,fontWeight: FontWeight.w600,letterSpacing: 0.2),overflow: TextOverflow.ellipsis,),
                      ],
                    ),
                  ),
                  Container(
              ...
              Align(
                ...
                child: Padding(
                  padding: EdgeInsets.fromLTRB(25,2,25,0),
                  child: Text("Equipements".toUpperCase(),style: TextStyle(color: Colors.black,fontSize: 18,fontWeight: FontWeight.w600,letterSpacing: 0.2),overflow: TextOverflow.ellipsis,),
                ),
              ),
              ...
              Padding(
                ...
                child: Align(
                  alignment: Alignment.topLeft,
                  child:  Text("(45 comments)",style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.w500,letterSpacing: 0.2),overflow: TextOverflow.ellipsis,),
                ),
              ) ,
              SizedBox(height: 25,),
              Padding(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
                        Text("Anuj",style: TextStyle(color: Colors.black,fontSize: 16,fontWeight: FontWeight.w500,letterSpacing: 0.2),overflow: TextOverflow.ellipsis,),
                        Text("October 1",style: TextStyle(color: Colors.black45,fontSize: 14,fontWeight: FontWeight.w500,letterSpacing: 0.2),overflow: TextOverflow.ellipsis,)
                      ],
                    )
                  ],
                ),
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Text("Swimming",style: commodite.piscine? active: bare),
        ...
        Padding(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Text("Repay ",style: commodite.repasInclus? active: bare),
        ...
        Padding(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Text("Child allowed ",style: commodite.enfantAutorise? active: bare),
        ...
        Padding(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: <Widget>[
              Text("Equipped",style: commodite.equipe? active: bare),
    ...
    return Column(
      children: <Widget>[
        Padding(
          ...
          Align(
            alignment: Alignment.topLeft,
            child:  Text("A modern furnished apartment in a quiet area but very close to the bustling street of Noida",style: TextStyle(color: Colors.black54,fontSize: 14,fontWeight: FontWeight.w400,letterSpacing: 0.2),overflow: TextOverflow.ellipsis,maxLines: _maxLines1,),
          ) ,
        ),
        Padding(
          ...
          child: GestureDetector(
            ...
            child: Row(
              children: <Widget>[
                Text("See more items",style: TextStyle(decoration: TextDecoration.underline,fontWeight: FontWeight.w500,fontSize: 16),),
  ...
  buildDescreption(BuildContext context) {
    return Padding(
      ...
      child: Text("Quiet, carefully designed, and furnished apartment",style: TextStyle(fontSize: 20,color: Colors.black,),overflow: TextOverflow.ellipsis,maxLines: 2,),
    );
  }
}
