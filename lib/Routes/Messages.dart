                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: <Widget>[
                                      ...
                                      children: <Widget>[
                                        Center(
                                          child: Icon(
                                            ...
                                            size: 40, // You can adjust the icon size here
                                          ),
                                        ),
                                      ],
                                    ),
                                  ...
                                  Flexible(
                                      child: Text("An admin has accepted your request",style: TextStyle(fontSize:12),maxLines: 2,overflow: TextOverflow.ellipsis,)),
