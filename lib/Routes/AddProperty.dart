            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("2 Advertisements",style: TextStyle(color:Colors.black87,fontSize: 22,fontWeight: FontWeight.bold),),
                      ...
                      children: <Widget>[
                        Container(
                          height:80,
                            ...
                            child: Center(child: Text("Private room in India",style: TextStyle(fontSize:15,fontWeight: FontWeight.w300),maxLines: 5,textAlign: TextAlign.center,))),
                        Container(
                        ...
                        children: <Widget>[
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              child: Text("Create another advertisement",style: TextStyle(fontWeight: FontWeight.w500),))
                        ],
                      ),
                    ),
                  ),
