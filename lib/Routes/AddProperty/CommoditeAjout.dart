...
class _CommoditeAjoutState extends State<CommoditeAjout> {
  ...
  var _Childpermitted=false;

  var _Smokingallowed=false;
  @override
              ...
              GestureDetector(
                child: Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      Text("Team",style: TextStyle(fontSize: 15),),
                      Container(
                          height: 35,
                          decoration: BoxDecoration(shape: BoxShape.circle, color: _Team? Colors.blue:Colors.black12),
                          child: _Team
                              ? Icon(
                            Icons.check,
                            size: 30.0,
              ...
              GestureDetector(
                child: Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      Text("Child Allowed",style: TextStyle(fontSize: 15),),
                      Container(
                          height: 35,
                          decoration: BoxDecoration(shape: BoxShape.circle, color: _Childpermitted? Colors.blue:Colors.black12),
                          child: _Childpermitted
                              ? Icon(
                            Icons.check,
                            size: 30.0,
                            color: Colors.white,
                ...
                onTap: (){
                  setState(() {
                    _Childpermitted=!_Childpermitted;
                  });
                },
              ),
              SeparateurHorizontal(),
              GestureDetector(
                child: Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      Text("Smoking Allowed",style: TextStyle(fontSize: 15),),
                      Container(
                          height: 35,
                          decoration: BoxDecoration(shape: BoxShape.circle, color: _Smokingallowed? Colors.blue:Colors.black12),
                          child: _Smokingallowed
                              ? Icon(
                            Icons.check,
                            size: 30.0,
                            color: Colors.white,
