                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text("Start by choosing a general category",style: TextStyle(color:Colors.black,fontSize: 15,fontWeight: FontWeight.w400),),
                    ),
                    Padding(
                      padding:  EdgeInsets.fromLTRB(10,12,10,3),
                      child: Text(" choosing general category",style: TextStyle(color:Colors.grey,fontSize: 13,fontWeight: FontWeight.w300),),
                    ),
                  ],
                ),
              ),
              ...
              InkWell(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      padding:  EdgeInsets.fromLTRB(10,8,10,0),
                      child: Text("choose a type of accommodation now",style: TextStyle(color:Colors.black,fontSize: 15,fontWeight: FontWeight.w400),),
                    ),
                    Padding(
                      padding:  EdgeInsets.fromLTRB(10,12,10,3),
                      child: Text("Select an option",style: TextStyle(color:Colors.grey,fontSize: 13,fontWeight: FontWeight.w300),),
                    ),
                  ],
                ),
              ),
    ...
    switch (await showDialog<String>(
        ...
        builder: (BuildContext context) {
          return SimpleDialog(
            children: <Widget>[
              SimpleDialogOption(
                onPressed: () { Navigator.pop(context, "Entire place"); },
                child: const Text('Entire place'),
              ),
              SimpleDialogOption(
                onPressed: () { Navigator.pop(context, "Shared room"); },
                child: const Text('Shared room'),
              ),
            ],
          );
        }
